      ...
      <div>
        ...
        <Form onSubmit={async() => {
          ...
          <Form.Field>
            ...
            <input placeholder='yyyy-MM-ddThh:mm:ss' defaultValue={format(new Date().setHours(new Date().getHours()+1), "yyyy-MM-dd'T'HH:mm:ss")} value={this.state.mailItem.sendDate}
              disabled />
          </Form.Field>
          <Form.Field>
